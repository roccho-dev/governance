...
This README is an accepted ADRS projection surface for the `modules/` package. It remains non-authority evidence and must not be treated as an accepted decision record.
